 ...
 */
const char *gNovelVMVersion = NOVELVM_VERSION NOVELVM_REVISION;
#if defined(__amigaos4__) || defined(__MORPHOS__)
static const char *version_cookie __attribute__((used)) = "$VER: NovelVM " NOVELVM_VERSION NOVELVM_REVISION " (" AMIGA_DATE ")";
#endif
const char *gNovelVMBuildDate = __DATE__ " " __TIME__;
const char *gNovelVMVersionDate = NOVELVM_VERSION NOVELVM_REVISION " (" __DATE__ " " __TIME__ ")";
const char *gNovelVMFullVersion = "NovelVM " NOVELVM_VERSION NOVELVM_REVISION " (" __DATE__ " " __TIME__ ")";
const char *gNovelVMFeatures = ""
#ifdef TAINTED_BUILD
