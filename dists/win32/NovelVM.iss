#define AppName "NovelVM"
#define FileVersion=GetFileVersion('novelvm.exe') 
#define ProductVersion=GetStringFileInfo('novelvm.exe', 'ProductVersion')
#define Copyright=GetStringFileInfo('novelvm.exe', 'LegalCopyright')
...
Name: "{userdesktop}\NovelVM"; Filename: "{app}\novelvm.exe"; Tasks: desktopicon
...
Name: {group}\NovelVM (noconsole); Filename: {app}\novelvm.exe; Parameters: "--no-console"; WorkingDir: {app}; Comment: novelvm; Flags: createonlyiffileexists; IconIndex: 0; Languages: not german
Name: {group}\NovelVM (ohne Konsolenfenster); Filename: {app}\novelvm.exe; Parameters: "--no-console"; WorkingDir: {app}; Comment: novelvm; Flags: createonlyiffileexists; IconIndex:0; Languages: german
Name: {group}\Saved Games\Saved Games; Filename: {userappdata}\NovelVM\Saved Games; WorkingDir: {userappdata}\NovelVM\Saved Games; Comment: Saved Games; IconIndex: 0; MinVersion: 0, 1; Languages: not german
Name: {group}\Spielst�nde\Spielst�nde; Filename: {userappdata}\NovelVM\Saved Games; WorkingDir: {userappdata}\NovelVM\Saved Games; Comment: Spielst�nde; IconIndex: 0; MinVersion: 0, 1; Languages: german
...
Name: "{userappdata}\NovelVM\Saved Games"; MinVersion: 0, 1; Flags: uninsneveruninstall
...
; NovelVM executable and libraries
