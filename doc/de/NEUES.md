...
-   Sprachausgabe in Macintosh-Versionen korrigiert, wenn NovelVM
...
-   Absturz beseitigt, wenn Geschwindigkeits- bzw. Lautstärkeregler angeklickt
    und dann aus dem NovelVM-Fenster gezogen wurden.
...
-   Anstatt des aktuellen Verzeichnisses wird nun folgendes Standardverzeichnis
    auf folgenden Plattformen für Spielstände verwendet: - Mac OS X: $HOME/Documents/NovelVM Savegames/ - Andere UNIX-Systeme: $HOME/.novelvm/
...
-   NovelVM warnt nun den Anwender, wenn Speichern fehlschlägt, anstatt
    abzustürzen.
...
-   Störung beim Beenden von NovelVM im Vollbildmodus unter Mac OS X
    beseitigt.
