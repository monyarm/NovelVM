...
NovelVM supports various in-game keyboard and mouse shortcuts, and since version 2.2.0 these can be manually configured in the :doc:`Keymaps tab <../settings/keymaps>`, or in the :doc:`configuration file <../advanced_topics/configuration_file>`.

For game-specific controls, see the `wiki entry <https://wiki.novelvm.org/index.php?title=Category:Supported_Games>`_ for the game you are playing. 
