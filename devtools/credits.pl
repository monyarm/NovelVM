...
# NovelVM in a single central location. We then generate the various versions
...
begin_credits("Credits");
	begin_section("NovelVM Team", "novelvm_team");
		...
		begin_section("Retired Project Leaders", "retired_leaders");
			begin_persons();
				...
				add_person("Vincent Hamm", "yaz0r", "NovelVM co-founder, Original Cruise/CinE author");
				add_person("Max Horn", "Fingolfin", "");
				add_person("Ludvig Strigeus", "ludde", "Original NovelVM and SimonVM author");
			end_persons();
		end_section();
	...
	begin_section("Other contributions", "other_contrib");
		...
		begin_section("Websites (design)", "web_design");
			begin_persons();
				...
				add_person("Jean Marc Gimenez", "", "NovelVM logo");
				add_person("David Jensen", "Tyst", "SVG logo conversion");
				add_person("", "Raina", "NovelVM forum buttons");
			end_persons();
		end_section();
		...
		begin_section("Code contributions", "code_contrib");
			begin_persons();
				...
				add_person("Sean Murray", "lightcast", "NovelVM tools GUI application (GSoC 2007 task)");
	...
	begin_section("Special thanks to", "special_thanks");
		begin_persons();
			...
			add_person("Kevin Carnes", "", "For Scumm16, the basis of NovelVM's older gfx codecs");
			...
			add_person("Till Kresslein", "Krest", "For design of modern NovelVM GUI");
		...
		add_paragraph(
			...
			"support while porting the engine to NovelVM.");
