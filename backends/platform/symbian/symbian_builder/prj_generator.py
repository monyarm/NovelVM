...
RESOURCE APP_REGISTRATION_INFO
	{
	app_file = "NovelVM%s"; // filename of application binary (minus extension)
	// Specify the location of the localisable icon/caption definition file
	localisable_resource_file = "\\Resource\\Apps\\NovelVM%s_loc";
	}
"""
...
RESOURCE LOCALISABLE_APP_INFO
	...
	caption_and_icon =
		...
		CAPTION_AND_ICON_INFO
			...
			icon_file = "\\Resource\\Apps\\NovelVM.mif";
			}
		};
	}
"""
...
RESOURCE MENU_BAR r_scum_menubar                                         // *** Menu bar
{
      titles =
    {
		MENU_TITLE { menu_pane = r_scum_menu; txt = "NovelVM%s"; }
	};
}
...
//
// EPOC S60 MMP makefile project for NovelVM
//

// *** Definitions


TARGET          NovelVM%s.exe
TARGETPATH      sys\\bin
TARGETTYPE      exe
...
START RESOURCE  NovelVM%s.rss
HEADER
TARGETPATH              \Resource\Apps
LANG                    SC
END

START RESOURCE  NovelVM%s_reg.rss
TARGETPATH              \private\\10003a3f\\apps
END

START RESOURCE  NovelVM%s_loc.rss
TARGETPATH              \Resource\Apps
LANG                    SC
END
