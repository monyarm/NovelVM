...
riscosdist: $(APP_NAME)/docs/NovelVM,3d6 # $(APP_NAME)/docs/de/NovelVM,3d6 $(APP_NAME)/docs/cz/NovelVM,3d6 $(APP_NAME)/se/NovelVM,3d6

README=${srcdir}/README.md
NEWS=${srcdir}/NEWS.md
$(APP_NAME)/docs/de/NovelVM,3d6: README=${srcdir}/doc/de/LIESMICH
$(APP_NAME)/docs/de/NovelVM,3d6: NEWS=${srcdir}/doc/de/NEUES.md
$(APP_NAME)/docs/cz/NovelVM,3d6: README=${srcdir}/doc/cz/PrectiMe
$(APP_NAME)/docs/se/NovelVM,3d6: README=${srcdir}/doc/se/LasMig
